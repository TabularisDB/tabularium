...
packages/
  ...
  manifest/        @tabularium/manifest — validador puro + primitivas de integridad
  cli/             @tabularium/cli — `tabularium validate` para autores
  tsconfig/        tsconfig compartido
deploy/            manifests k3s + script de build de imagen
