...
function createI18nStore() {
	...
	return {
		get defaultLocale() { return state.defaultLocale },
		get enabledLocales() { return state.enabledLocales },
		get availableLocales() { return state.availableLocales },
		get current() { return current },
		get loaded() { return loaded },
		refresh,
		set,
		sync() { current = getLocale() as Locale },
	}
}
