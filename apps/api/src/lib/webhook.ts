...
const PLATFORM_PATTERNS: Array<[RegExp, string]> = [
  [/linux[_-](arm64|aarch64)|(arm64|aarch64)[_-]linux/i, 'linux-arm64'],
  [/linux[_-](x64|amd64|x86[_-]?64)|(amd64|x86[_-]?64)[_-]linux/i, 'linux-x64'],
  [/(darwin|macos)[_-](arm64|aarch64)|(arm64|aarch64)[_-](darwin|macos)/i, 'darwin-arm64'],
  [/(darwin|macos)[_-](x64|amd64|x86[_-]?64)/i, 'darwin-x64'],
  [/(win(dows)?)[_-](arm64|aarch64)/i, 'win-arm64'],
  [/(win(dows)?)[_-](x64|amd64|x86[_-]?64)/i, 'win-x64'],
