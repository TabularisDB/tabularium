...
export default new Elysia()
  .get('/', () => ({
    description:
      'Plugin authors drop a `.pluggr` (YAML), `.pluggr.yaml`, `.pluggr.yml`, or `.pluggr.json` file in their repo root. ' +
    ...
    paths: ['.pluggr', '.pluggr.yaml', '.pluggr.yml', '.pluggr.json'],
    schema: ManifestSchema,
    example: EXAMPLE,
  }), {
    detail: {
      tags: ['Plugins'],
      summary: 'Discoverable .pluggr manifest spec',
